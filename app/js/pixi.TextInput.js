...
(function(){
	TextInput = function(style, options)
	{
		options = options || {};
	...
	// constructor
	TextInput.prototype = Object.create(PIXI.Text.prototype);
	TextInput.prototype.constructor = TextInput;

	TextInput.prototype.add = function(ch)
	{
		if (this.text.length < this.maxLength) this.setText(this.text + ch);
	};

	TextInput.prototype.backspace = function()
	{
		this.setText(this.text.slice(0, -1));
	};

	TextInput.prototype.keyInput = function(e)
	{
		if (!listening) return;
		e = e || window.event;
